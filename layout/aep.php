<div class="main-panel">
      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header">
            <h4 class="card-title"><i class="material-icons-outlined card-icon">class</i>My Gradebook - Academics & English Preparetion (AEP)</h4>
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-md-6 ">
              <button type="button" class="btn btn-default btn-sm mg-r-10 btn-iap" data-toggle="modal" data-target="#iapMdl">IAP</button>
              <button type="button" class="btn btn-default btn-sm mg-r-10 btn-midComment" data-toggle="modal" data-target="#aepCommentMdl">Mid-term Comment</button>
              <button type="button" class="btn btn-default btn-sm mg-r-10 btn-final" data-toggle="modal" data-target="#aepCommentMdl">Final Comment</button>
  ...
  <script src="js/modalControl.js?ver=3.5" charset="utf-8"></script>
